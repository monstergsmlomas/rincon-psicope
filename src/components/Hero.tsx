  ...
  return (
    <section id="inicio" className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-rose-100 via-pink-50 to-purple-100">
        <div className="absolute top-20 left-10 w-72 h-72 bg-rose-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32">
        <div className="text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-md border border-rose-100 mb-6">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-lg border border-rose-50">
              <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-rose-500 to-purple-500 bg-clip-text text-transparent">
                +500
              </div>
              <div className="text-sm text-gray-600 mt-1">Profesionales confían</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-lg border border-rose-50">
              <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-rose-500 to-purple-500 bg-clip-text text-transparent">
                +50
              </div>
              <div className="text-sm text-gray-600 mt-1">Recursos disponibles</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-lg border border-rose-50">
              <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-rose-500 to-purple-500 bg-clip-text text-transparent">
                100%
              </div>
              <div className="text-sm text-gray-600 mt-1">Digital y accesible</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-lg border border-rose-50">
              <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-rose-500 to-purple-500 bg-clip-text text-transparent">
                ⭐ 5.0
              </div>
              <div className="text-sm text-gray-600 mt-1">Valoración promedio</div>
            </div>
          </div>
        </div>
      </div>
